...
# b) Generate failed logins and test
	...
	dateAndUser=$(echo "$logs" | awk '{split($15,a,"="); print $1 " " $2 " " $3 " - " a[2]}')
	echo "$dateAndUser"
}

# Sending logins as email - Do not forget to change email address
# to your own email address
echo "To: aidan.stewart@mymail.champlain.edu" > emailform.txt
echo "Subject: Logins" >> emailform.txt
getLogins >> emailform.txt
cat emailform.txt | ssmtp aidan.stewart@mymail.champlain.edu
